...
class TranslatorClass:
    ...
    def __init__(self, root):
        ...
        self.mainframe = LabelFrame(self.root, text="source language", font=("Ariel", 15, "bold"), bg="white",
        ...
        Label(self.mainframe, text="Select a language", font=fontStyle, bg="white").grid(row=0, column=0)
        ...
        mainframe2 = LabelFrame(self.root, text="Destination language", font=("Ariel", 15, "bold"), bg="white",
                                fg="black", bd=5, relief=GROOVE)
        ...
        Label(mainframe2, text="Select a language", font=fontStyle, bg="white").grid(row=0, column=0)
        ...
        Label(self.mainframe, text="Enter text", font=fontStyle, bg="white").grid(row=3, column=0)

        self.var = StringVar()
        var1 = StringVar()

        textbox = Entry(self.mainframe, bd=0, textvariable=self.var, bg="white", font=("Arial", 20)).grid(row=4, column=0)

        mainframe3 = LabelFrame(self.root, text="Output", font=("Ariel", 15, "bold"), bg="white",
                                fg="black", bd=5, relief=GROOVE)

        mainframe3.place(x=0, y=200, width=700, height=200)

        self.out = Text(mainframe3, font=("Ariel", 30), bg="white", wrap=WORD, height=200, width=400)
